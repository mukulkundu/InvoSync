...
export default function InvoiceCard({ invoice, index }: InvoiceCardProps) {
  ...
  return (
    <div className="flex justify-between items-center p-4 bg-white rounded-2xl shadow-sm mb-3 mx-4 lg:mx-0">
      <div className="flex-1">
        <p className="font-medium text-gray-800 mb-1">{invoice.client}</p>
        <p className="text-xs text-gray-500">₹{invoice.amount.toLocaleString()}, Due {invoice.due}</p>
      </div>
